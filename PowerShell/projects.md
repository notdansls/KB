...
| A | B | [C](#c) | D | E | F | G | H | I | J | K | L | M | N | O | P | Q | R | S | T | V | W | X | Y | Z |
...
This project allows you to search your mailbox for calendar entries that have been added by a user who has since left the organisation. Usefull for when you have abandoned events.
